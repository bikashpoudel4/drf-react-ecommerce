...
function ProductDetail() {
    ...
    useEffect(() => {
        apiInstance.get(`products/${param.slug}/`).then((res) => {
            setProduct(res.data)
            // setSpecifications(res.data.specification) specification from django model
            setSpecifications(res.data.specification)
            setGallery(res.data.gallary)
                                ...
                                <form action="">
                                    <div className="row flex-column">
                                        ...
                                        <div className="col-md-6 mb-4">
                                            <div className="">
                                                {size?.map((s, index) => (
                                                    <button className='btn btn-sm btn-secondary me-2' key={index}>{s.name}</button> 
                                                ))}
                                            </div>
                                        ...
                                        <div className="col-md-6 mb-4">
                                            <div className="">
                                                {color?.map((c, index) => (
                                                <button className='btn p-3 me-2 bou' style={{backgroundColor: `${c.color_code}`}} key={index}></button>
                                                ))}
                                            </div>
